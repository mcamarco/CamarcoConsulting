      ...
      <div className='container'>
        ...
        <div className='row'>
          <div className='col-sm-12 col-md-6 col-lg-4'>
            <section className='card bg-white text-black mb-4' id='expertise'>
              <div className='card-body'>
          ...
          <div className='col-sm-12 col-md-6 col-lg-4'>
            <section className='card bg-white text-black mb-4' id='approach'>
              <div className='card-body'>
          ...
          <div className='col-sm-12 col-md-6 col-lg-4'>
            <section className='card bg-white text-black mb-4' id='partnership'>
              <div className='card-body'>
